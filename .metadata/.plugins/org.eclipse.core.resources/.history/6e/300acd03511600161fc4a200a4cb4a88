...
public class ToolBarHelper {
    ...
    * */
    ...
    public ToolBarHelper(Context context, int layoutId,String titleName) {
    ...
    private void initToolBar() {
        ...
        mToolBar.setTitle("");
		title=(TextView) toolbarView.findViewById(R.id.toolbar_title);
		SetTitle(titleName);
    }
    ...
    public void SetTitle(String activityName)
    {
    	title.setText(activityName);
    	title.setTextSize(mContext.getResources().getDimensionPixelOffset(R.dimen._20px));
    }
}