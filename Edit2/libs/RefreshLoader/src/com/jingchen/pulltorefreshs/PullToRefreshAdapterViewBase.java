...
import com.jingchen.pulltorefreshs.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private Runnable  autoRefresh_run=new Runnable() {
	...
	public void autoRefresh(){
        this.postDelayed(autoRefresh_run,500);
    }
	
	public void removeAutoRefresh_run()
	{
		this.removeCallbacks(autoRefresh_run);
	}
